...
class User(AbstractUser):
    ...
    teacher_number = PhoneNumberField(null=False, default='+000000000000', verbose_name='Номер учителя')
    ...
    user_number = PhoneNumberField(null=False, default='+000000000000', verbose_name='Телефон учащегося')
    ...
    parent_first_number = PhoneNumberField(null=False, default='+000000000000', verbose_name='Телефон Представителя 1')
    ...
    parent_second_number = PhoneNumberField(null=False, default='+000000000000', verbose_name='Телефон Представителя 2')
    rewards = models.TextField(null=True)
